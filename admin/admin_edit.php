...
<form id="passwordForm" action="admin_update.php" enctype="multipart/form-data" method="POST">
...
<div class="col-md-12">
    ...
    <small class="error-message" style="color: red;"></small>
            ...
            <div class="mt-5 text-center"><a href="index.php?username=<?php echo $usname; ?>"><input class="btn btn-primary profile-button" name="btn" type="button" value="Admin panel" /></a></div>
            </div>
        </div>
    </div>
</div>
